...
os.makedirs("/root/SDCA-imputation/suboutput/20suboutput", exist_ok=True)

# 读取单细胞矩阵文件
data = pd.read_csv('/root/SDCA-imputation/data/30data/A.csv')
...
imputed_df.to_csv('/root/SDCA-imputation/suboutput/20suboutput/a_out.csv', index=False)
print("插补完成！")
