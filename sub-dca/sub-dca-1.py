...
# 输出到A文件夹下
df_c.to_csv('/root/SDCA-imputation/output1/A.CSV', index=False)
...
imputed_df.to_csv('/root/SDCA-imputation/output1/imputed_data_A.csv', index=False)

# 读取插补后的数据
imputed_df = pd.read_csv('/root/SDCA-imputation/output1/imputed_data_A.csv')
