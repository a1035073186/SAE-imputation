...
# 读取原始数据B.CSV
df_b = pd.read_csv('/root/SDCA-imputation/csvdata/chen_samp.csv')

# 读取预测结果A.CSV
df_a = pd.read_csv('/root/SDCA-imputation/suboutput/b_out.csv')
...
# 输出到A文件夹下
df_c.to_csv('/root/SDCA-imputation/output1/B.CSV', index=False)
...
imputed_df.to_csv('/root/SDCA-imputation/output1/imputed_data_B.csv', index=False)

# 读取插补后的数据
imputed_df = pd.read_csv('/root/SDCA-imputation/output1/imputed_data_B.csv')
